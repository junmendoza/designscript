...
namespace ProtoCore.Utils
{
    ...
    private static void InsertPredefinedMethod(Core core, ProtoCore.AST.Node root, bool builtinMethodsLoaded)
    {
        ...
        public static string GenerateIdentListNameString(ProtoCore.AST.ImperativeAST.ImperativeNode node)
        {
            ProtoCore.AST.ImperativeAST.IdentifierListNode iNode;
            ProtoCore.AST.ImperativeAST.ImperativeNode leftNode = node;
            List<string> stringList = new List<string>();
            while (leftNode is ProtoCore.AST.ImperativeAST.IdentifierListNode)
            {
                iNode = leftNode as ProtoCore.AST.ImperativeAST.IdentifierListNode;
                leftNode = iNode.LeftNode;
                if (iNode.RightNode is ProtoCore.AST.ImperativeAST.IdentifierNode)
                {
                    stringList.Add((iNode.RightNode as ProtoCore.AST.ImperativeAST.IdentifierNode).Value);
                }
                else if (iNode.RightNode is ProtoCore.AST.ImperativeAST.FunctionCallNode)
                {
                    ProtoCore.AST.ImperativeAST.FunctionCallNode fCall = iNode.RightNode as ProtoCore.AST.ImperativeAST.FunctionCallNode;
